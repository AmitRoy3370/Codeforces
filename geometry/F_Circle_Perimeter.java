...
public class F_Circle_Perimeter {
    ...
    static int testCases, n, x_, y_, k, count = 1, d, w, h, a11, b1, f, g, m, s, q, a_, b_, c_, N = (int) (1e6 + 1);
    ...
    static long A_, B_, N_, K, sum = 0L, G, a1, ak, X, Y, A, B, C, l_, t_, P, r;
    ...
    static void solve(int t) {
    	...
    	for(long xAxis = 1L; xAxis != r + 1; ++xAxis) {
    		
    		long yAxis = (long)Math.sqrt(((r * r) - (xAxis * xAxis)));
    		
    		long greaterThanOrEqaulToR = ((r * r) > ((xAxis * xAxis) + (yAxis * yAxis))) ? yAxis + 1 : yAxis;
    		
    		yAxis = (long)Math.sqrt(((r + 1) * (r + 1)) - (xAxis * xAxis));
    		
    		long lessThanRPlusOne = ((r + 1) * (r + 1)) <= (xAxis * xAxis + yAxis * yAxis) ? yAxis - 1: yAxis;
    		
    		sum += (lessThanRPlusOne - greaterThanOrEqaulToR + 1);
