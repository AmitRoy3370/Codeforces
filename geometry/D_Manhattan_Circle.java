...
public class D_Manhattan_Circle {
    ...
    static void solve(int t) {
    	...
    	ArrayList1<Integer> xAxis = new ArrayList1<>();
    	ArrayList1<Integer> yAxis = new ArrayList1<>();
    	...
    	ans.append(xAxis.get((int)Math.ceil(xAxis.size() / 2))).append(" ").append(yAxis.get((int)Math.ceil(yAxis.size() / 2)));
