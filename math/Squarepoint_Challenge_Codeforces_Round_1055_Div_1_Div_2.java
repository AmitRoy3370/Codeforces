...
public class Squarepoint_Challenge_Codeforces_Round_1055_Div_1_Div_2 {
    ...
    static void D(int t) {
        ...
        for(int i = 1; i <= n; ++i) {
            ...
            int bitPosition = 63 - (int)Long.numberOfLeadingZeros(a[i]);
            bit[i] = bitPosition;
    ...
    static void A(int t) {
        ...
        mul = Long.parseLong(mul("2", distinct + ""));
        mul = Long.parseLong(sub(mul + "", "1"));
