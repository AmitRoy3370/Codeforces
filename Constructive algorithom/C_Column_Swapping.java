...
public class C_Column_Swapping {
    ...
    static void solve(ArrayList<Integer> indexes, int i) {
        ...
        switch (indexes.size()) {
            ...
            case 2:
                ...
                for (int i = 0; i < n; ++i) {
                    ...
                    long temp = a[i][index[0]];
                    a[i][index[0]] = a[i][index[1]];
                    a[i][index[1]] = temp;
                ...
                ans.append(index[0] + 1).append(" ").append(index[1] + 1);
                break;
            default:
                ans.append(-1);
                break;
