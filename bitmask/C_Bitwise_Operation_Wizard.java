...
public class C_Bitwise_Operation_Wizard {
    ...
    public static void main(String[] Priya) throws IOException {
        ...
        for (int t = 0; t < testCases; ++t) {
        	...
        	for(int i = 1; i < n; ++i) {
        		...
        		System.out.println("? " + maxBit + " " + maxBit + " " + i + " " + i);
        		
        		x = in.next().toCharArray();
        		
        		if(new String(x).equals("<")) {
        	...
        	for(int i = 1; i < n; ++i) {
        		...
        		System.out.println("? " + maxBit + " " + minBit + " " + maxBit + " " + i);
        		...
        		} else if(new String(x).equals("=")) {
        			
        			System.out.println("? " + minBit + " " + minBit + " " + i + " " + i);
        	...
        	System.out.println("! " + maxBit + " " + minBit);
