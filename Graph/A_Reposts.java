...
public class A_Reposts {
    ...
    static int solve(String source, Map<String, List<String>> map, int len) {
    	
    	maxLen = Math.max(maxLen, len);
    	
    	//System.out.println(source + " " + len);
    	...
    	//System.out.println(source + " - " + map.get(source).size());
    	
    	for(String i : map.get(source)) {
    		
    		maxLen = Math.max(maxLen, len + 1);
    		
    		//System.out.println("i :- " + i);
    		
    		maxLen = Math.max(maxLen, solve(i, map, len + 1));
    ...
    static void solve(int t) {
    	...
    	maxChainLen = solve("polycarp", map, 1);
    	
    	ans.append(maxChainLen);
