...
public class Codeforces_Round_833_Div_2 {
    ...
    static long block = 0L;

    static void C_Zero_Sum_Prefixes(int t) {
		...
		int final_ans = 0, max = 0;
		
		/*final_ans += (zeros[0] == n ? zeros[0] : 0);
    ...
    static void B_Diverse_Substrings(int t) {
    ...
    static void A_The_Ultimate_Square(int t) {

        long final_ans = (block % 2L == 1L ? (block + 1L) / 2L : (long) Math.ceil(block / 2L));
    ...
    public static void main(String[] Amit) throws IOException {
        ...
        for (int t = 0; t < testCases; ++t) {
            ...
            A_The_Ultimate_Square(t + 1);*/
 /*n = in.nextInt();

            x = in.next().toCharArray();

            B_Diverse_Substrings(t + 1);*/
            n = in.nextInt();
