...
public class D_Black_and_White_Stripe {
    ...
    static int solve(int i, int min, int count) {
        ...
        count = ((a[i] == 'W') ? count + 1 : count);

        if (isSmaller((k - 1) + "", (i) + "") || i == k - 1) {
    ...
    static void solve(int t) {
        ...
        int charCount = charCount(0, a, 'W', a.length, 0);

        if (String.valueOf(k).equalsIgnoreCase(String.valueOf(n))) {
    ...
    static int charCount(int i, char a[], char x, int n, int count) {
        ...
        return charCount(i + 1, a, x, n, count);
