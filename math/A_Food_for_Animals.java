...
public class A_Food_for_Animals {
    ...
    static void solve(int t) {
        ...
        if (a == 0 && a == b && b == c && c == x && x == y) {

            ans.append("YES");

        } else {

            if ((isSmaller(String.valueOf(x), String.valueOf(a)) || a == x) && ((isSmaller(String.valueOf(y), String.valueOf(b)) || b == y))) {

                ans.append("YES");

            } else if ((isSmaller(String.valueOf(x), String.valueOf(a + c)) || a + c == x) && ((isSmaller(String.valueOf(y), String.valueOf(b)) || b == y))) {

                ans.append("YES");

            } else if ((isSmaller(String.valueOf(x), String.valueOf(a)) || a == x) && ((isSmaller(String.valueOf(y), String.valueOf(b + c)) || b + c == y))) {

                ans.append("YES");

            } else if (!isSmaller(String.valueOf(c), String.valueOf(Math.abs(x - a) + Math.abs(y - b))) || Math.abs(x - a) + Math.abs(y - b) == c) {
