...
public class B_Lady_Bug {
    ...
    static void solve(int t) {
    	...
    	for(int i = 0; i < n; i += 2) {
    		...
    		first.append(mat[0][i]);
    		
    		if(i + 1 < n) {
    		
    		   first.append(mat[1][i + 1]);
    		
    		}
    		
    		second.append(mat[1][i]);
    		
    		if(i + 1 < n) {
    		
    		   second.append(mat[0][i + 1]);
    	...
    	for(char i : first.toString().toCharArray()) {
    	...
    	for(char i : second.toString().toCharArray()) {
    	...
    	if(firstCountZero >= (n + 1) / 2 && secondCountZero >= n / 2) {
