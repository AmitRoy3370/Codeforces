...
public class D_Binary_String_To_Subsequences {
    ...
    static void solve(int t) {
    	...
    	ArrayList1<Integer> list[] = new ArrayList1[2];
    	
    	list[0] = new ArrayList1<>();
    	list[1] = new ArrayList1<>();
    			...
    			if(i == 0) {
    				...
    				if(x[i] != x[i - 1]) {
    					...
    					if(list[1].size() == 0) {
    						...
    						dp[i] = dp[list[1].get(0)];
    						used[list[1].get(0)] = true;
    						list[1].popFront();
    			...
    			if(i == 0) {
    				...
    				if(x[i] != x[i - 1]) {
    					...
    					if(list[0].size() == 0) {
    						...
    						dp[i] = dp[list[0].get(0)];
    						used[list[0].get(0)] = true;
    						list[0].popFront();
