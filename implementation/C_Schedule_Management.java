...
public class C_Schedule_Management {
    ...
    static int solve(int start, int end, long count[]) {
    ...
    static void solve(int t) {
        ...
        int total_value = (n + m - 1) / n;
        int start = total_value, end = Integer.parseInt(mul(2 + "", m + ""));

        start = solve(start, end, count);
