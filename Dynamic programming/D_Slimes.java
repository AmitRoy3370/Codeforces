    ...
    static void solve(int t) {
    	...
    	for(int i = 1; i != n; ++i) {
    		...
    		while(right > left) {
    			...
    			long rangeSum = prefix[mid] - prefix[i];
    		...
    		if(n >= left) {
    			...
    			finalAns[i] = Math.min(finalAns[i], left - i);
    	...
    	for(int i = 1; i != n + 1; ++i) {
    		...
    		while(right > left) {
    			...
    			long rangeSum = (prefix[i - 1] - prefix[mid]);
    		...
    		if(left > 0) {
    			...
    			finalAns[i] = Math.min(finalAns[i], i - left);
