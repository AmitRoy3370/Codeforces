...
public class C_Odd_Even_Increments {
    ...
    private static boolean solve(int index, long a[], long comp) {
        ...
        if (index < n && a[index] % 2 != comp) {

            return false;

        }

        return solve(index + 2, a, comp);
    ...
    private static void solve(int t) {
        ...
        if (n == 1) {
            ...
            long odd = a[0] % 2, even = a[1] % 2;

            possible = solve(2, a, odd);
