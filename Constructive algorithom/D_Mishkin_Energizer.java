...
public class D_Mishkin_Energizer {
    ...
    static void operation(char ch, int i) {
    ...
    static char haveToSet(char a, char b) {
    ...
    static void solve(int t) {
    	...
    	if(n % 3 == 0 && L == T && T == I && L == I) {
    		...
    		while(true) {
    			...
    			if(x.length % 3 == 0 && L == T && T == I && L == I) {
    				
    				break;
    				
    			}
    			
    			int maxCount = Math.max(L, Math.max(T, I));
    			...
    			for(int i = 0; i < x.length - 1; ++i) {
    				...
    				char settedChar = haveToSet(x[i], x[i + 1]);
    				
    				if((maxCount > L && settedChar == 'L') || (maxCount > T && settedChar == 'T') || (maxCount > I && settedChar == 'I')) {
    					
    					find = true;
    					
    					operation(settedChar, i);
    					
    					if(settedChar == 'L') {
    						
    						++L;
    						
    					} else if(settedChar == 'T') {
    						
    						++T;
    						
    					} else if(settedChar == 'I'){
