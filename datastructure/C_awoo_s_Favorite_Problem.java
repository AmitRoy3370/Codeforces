...
public class C_awoo_s_Favorite_Problem {
    ...
    static boolean solve(int i, int j, boolean ok) {
        ...
        } else if (((a[i] == 'b') && (b[i] == 'a')) || ((a[i] == 'c') && (b[i] == 'b')) || ((a[i] == 'a') && (b[i] == 'c'))) {
    ...
    static void solve(int t) {
		...
		ArrayList1<Integer> B = new ArrayList1<>();
		ArrayList1<Integer> C = new ArrayList1<>();
