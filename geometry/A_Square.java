...
public class A_Square {
    ...
    static void solve(int t) {
    	...
    	for(int i = 0; i != n; ++i) {
    		...
    		point[i] = new Point(a[i], b[i]);
    		
    	}
    	
    	long len1 = point[0].distance(point[2]);
    	long len2 = point[0].distance(point[1]);
    	long len3 = point[1].distance(point[3]);
    	long len4 = point[2].distance(point[3]);
    	
    	if(!(len1 == len2 && len2 == len3 && len3 == len4)) {
    		
    		len1 = point[0].distance(point[3]);
    		len2 = point[0].distance(point[3]);
    		len3 = point[3].distance(point[1]);
    		len4 = point[1].distance(point[2]);
    		
    		if(!(len1 == len2 && len2 == len3 && len3 == len4))  {
    			
    			len1 = point[0].distance(point[3]);
    		    len2 = point[0].distance(point[1]);
    		    len3 = point[1].distance(point[2]);
    		    len4 = point[2].distance(point[3]);
    		
    		}
    		
    	}
    	
    	ans.append(pow(len1, 2L));
    ...
    private static class Point {
    	...
    	private long distance(Point p) {
    		...
    		return (long)Math.sqrt(pow(Math.abs(this.x - p.x), 2L) + pow(Math.abs(this.y - p.y) , 2L));
