...
public class B_Monsters_Attack {
    ...
    private static class Monster implements Comparable<Monster> {
    	...
    	public Monster(long power, long position) {
    	...
    	public int compareTo(Monster monster) {
    		...
    		if(this.position > monster.position) {
    			
    			return 1;
    			
    		} else if(this.position < monster.position) {
    ...
    static void solve(int t) {
    	...
    	for(int i = 0; i < n; ++i) {
    		...
    		power += list.get(i).power;
    		
    		long perMonsterBit = power / K;
    		...
    		if(list.get(i).position < perMonsterBit) {
