...
public class B_Shoe_Shuffling {
    ...
    static void solve(int t) {
        ...
        for (i = 0; i < size; ++i) {
            ...
            if (i + 1 < n && (i == 0 && e[i].value != e[i + 1].value)) {
            ...
            if (i - 1 >= 0 && (i == n - 1 && e[i].value != e[i - 1].value)) {
            ...
            if (i > 0 && i + 1 < n && e[i].value != e[i + 1].value && e[i].value != e[i - 1].value) {
            ...
            if (i + 1 < n && (e[i].value == e[i + 1].value)) {

                swap(index, e[i].i, e[i + 1].i);
    ...
    static class element {
        ...
        public element(long value, int i) {
            this.value = value;
            this.i = i;
        }
    ...
    static int comparable(element a, element b) {
    ...
    static void merge(element a[], int left, int right, int mid) {
        ...
        while (i < n1 && j < n2) {
            ...
            if (comparable(L[i], R[j]) == - 1 || comparable(L[i], R[j]) == 0) {
