...
public class C_Tree_Cutting {
    ...
    static int testCases, n, x_, y_, k, count = 1, d, w, h, a11, b1, f, g, m, s, l, r, q, a_, b_, c_, N = (int) (1e6 + 1);
    ...
    private static void dfs(int u, int parent, List<Integer> list[], int cut[], int expectedLength) {
    	...
    	for(int v : list[u]) {
    		...
    		dfs(v, u, list, cut, expectedLength);
    		
    		b[u] += b[v];
    	
    	}
    	
    	if(b[u] >= expectedLength && cut[0] < k && parent != 0) {
    ...
    static void solve(int t) {
    	...
    	while(r >= l) {
    		...
    		dfs(1, 0, list, cut, mid);
    		
    		if(cut[0] >= k && b[1] >= mid) {
    			
    			l = mid + 1;
    			maxComponentSize = Math.max(maxComponentSize, mid);
