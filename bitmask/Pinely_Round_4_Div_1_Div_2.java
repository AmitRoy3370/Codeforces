...
public class Pinely_Round_4_Div_1_Div_2 {
    ...
    static void D(int t) {
        ...
        switch (n) {
            ...
            case 2 -> sb.append("2").append("\n").append("1 2");
            case 3 -> sb.append("2").append("\n").append("1 2 2");
            case 4 -> sb.append("3").append("\n").append("1 2 2 3");
            case 5 -> sb.append("3").append("\n").append("1 2 2 3 3");
            default -> {
                sb.append("4").append("\n");
                for (int i = 1; i <= n; ++i) {

                    sb.append((i % 4) + 1).append(" ");
    ...
    static void C(int t) {
        ...
        ArrayList1<Long> finalAns = new ArrayList1<>();

        for (int oparation = 0; oparation < 40; ++oparation) {

            long max = max(a, n, 0, a[0]);

            long min = min(a, 0, n, a[0]);
        ...
        if (finalAns.size() == 0) {
            ...
            b = new long[finalAns.size()];

            int index = 0;

            while (!finalAns.isEmpty()) {

                b[index++] = finalAns.get(0);
    ...
    static boolean B(int i, long a[], long b[]) {
