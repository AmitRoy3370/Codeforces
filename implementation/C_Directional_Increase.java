...
public class C_Directional_Increase {
    ...
    static void solve(int i, long sum, int t) {
    ...
    static void solve(int t) {
        ...
        long sum = sum(0, a, n, 0);

        if (sum != 0 || a[0] < 0 || a[n - 1] > 0) {
    ...
    static long sum(int i, long a[], int n, long sum) {
