...
public class C_Permutation_Operations {
    ...
    static void solve(int i, long a[], PriorityQueue<pair> list, long max) {
        ...
        if (max > a[i]) {
            ...
            long difference = max - a[i];

            list.add(new pair(difference, i + 1));

        }

        solve(i + 1, a, list, max);
