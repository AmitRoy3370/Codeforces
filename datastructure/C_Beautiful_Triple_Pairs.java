...
public class C_Beautiful_Triple_Pairs {
    ...
    static void solve(int t) {
    	...
    	Map<String, Integer> a_c = new HashMap<>();
    	Map<String, Integer> b_c = new HashMap<>();
    	Map<String, Integer> a_b_c = new HashMap<>();
    	
    	sum = 0L;
    	
    	for(int i = 2; i != n; ++i) {
    		
    		sum += a_b.getOrDefault(a[i - 2] + "_" + a[i - 1], 0);
    		sum += a_c.getOrDefault(a[i - 2] + "_" + a[i], 0);
    		sum += b_c.getOrDefault(a[i - 1] + "_" + a[i], 0);
    		sum -= 3 * a_b_c.getOrDefault(a[i - 2] + "_" + a[i - 1] + "_" + a[i], 0);
    		
    		a_b.put(a[i - 2] + "_" + a[i - 1], a_b.getOrDefault(a[i - 2] + "_" + a[i - 1], 0) + 1);
    		a_c.put(a[i - 2] + "_" + a[i], a_c.getOrDefault(a[i - 2] + "_" + a[i], 0) + 1);
    		b_c.put(a[i - 1] + "_" + a[i], b_c.getOrDefault(a[i - 1] + "_" + a[i], 0) + 1);
    		a_b_c.put(a[i - 2] + "_" + a[i - 1] + "_" + a[i], a_b_c.getOrDefault(a[i - 2] + "_" + a[i - 1] + "_" + a[i], 0) + 1);
