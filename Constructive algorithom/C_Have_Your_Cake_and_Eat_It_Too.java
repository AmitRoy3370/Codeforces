...
public class C_Have_Your_Cake_and_Eat_It_Too {
    ...
    private static boolean possible(int []p, long value, long players[][]) {
    	...
    	for(int i = 0; i != n; ++i) {
    		...
    		sum += (players[p[index]][i]);
    		
    		if(sum >= value) {
    			
    			s[p[index]] = segmentStart + "_" + (i + 1);
