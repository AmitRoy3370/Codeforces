...
public class Educational_Codeforces_Round_141_Rated_for_Div_2 {
    ...
    static void C(int t) {
        ...
        if (myWin == 0) {
            ...
            if (last_value >= next || last_sum - a[last_visit] + next <= K) {
    ...
    static long endI_to_startI(int i, int startI, int startJ, long final_ans[][], long counter) {
        ...
        final_ans[i][startJ] = counter++;

        return endI_to_startI(i - 1, startI, startJ, final_ans, counter);

    }

    static long startI_to_endingI(int i, int endI, int endJ, long final_ans[][], long counter) {
        ...
        final_ans[i][endJ] = counter++;

        return startI_to_endingI(i + 1, endI, endJ, final_ans, counter);

    }

    static long startI_to_endI(int i, int startJ, long counter, long final_ans[][], int endI) {
        ...
        final_ans[endI][i] = counter++;

        return startI_to_endI(i - 1, startJ, counter, final_ans, endI);

    }

    static long startJ_toendJ(int i, long counter, int endJ, long final_ans[][], int startI) {
        ...
        final_ans[startI][i] = counter++;

        return startJ_toendJ(i + 1, counter, endJ, final_ans, startI);

    }

    static void B(int t) {

        long final_ans[][] = new long[n][n];
        ...
        if (n == 2) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                ArrayList1<Long> v = new ArrayList1<>();
        ...
        for (int i = 0; i < n; ++i) {
            ...
            for (int j = 0; j < n; ++j) {
                ...
                sb.append(final_ans[i][j]).append(" ");

            }

            mat.append(sb.toString().trim());
