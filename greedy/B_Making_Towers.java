...
public class B_Making_Towers {
    ...
    static void solve(int i, Map<Long, ArrayList1<Integer>> map) {
    ...
    static void solve(int t) {
        ...
        for (long i : map.keySet()) {
            ...
            ArrayList1<Integer> list = map.get(i);
            ...
            int position_indexes_array_size = arr.length;

            for (int i1 = 1; i1 < position_indexes_array_size; ++i1) {

                if ((arr[i1] - arr[i1 - 1] - 1) % 2 >= 1) {
