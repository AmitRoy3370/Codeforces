...
public class D_Very_Different_Array {
    ...
    static void solve(int t) {
    	...
    	ArrayList1<Long> assendingA = new ArrayList1<>();
    	ArrayList1<Long> desendingA = new ArrayList1<>();
    	
    	ArrayList1<Long> assendingB = new ArrayList1<>();
    	ArrayList1<Long> desendingB = new ArrayList1<>();
    	...
    	for(int i = 0; i != n; ++i) {
    		...
    		long minAmaxB = Math.abs(assendingA.get(0) - desendingB.get(0));
    		long maxAminB = Math.abs(assendingB.get(0) - desendingA.get(0));
    		
    		if(minAmaxB > maxAminB) {
