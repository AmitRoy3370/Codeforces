...
public class B_Sasha_and_the_Apartment_Purchase {
    ...
    static long A_, B_, N_, K, sum = 0L, sub = 0L, G, a1, ak, X, Y, A, B, C, l_, t_, P;
    ...
    static void solve(int t) {
    	...
    	sub = Long.parseLong(sub(a[(k + (n - k) / 2)] + "", a[(n - k - 1) / 2] + ""));
    	sub = Long.parseLong(sum(sub + "", "1"));
