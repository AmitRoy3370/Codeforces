...
public class Codeforces_Round_865_Div_2 {
    ...
    static void B(int t) {
        ...
        long front = 1, back = max - 2L;

        long Back = back, Front = front;

        ArrayList1<Long> list_back = new ArrayList1<>();
        ArrayList1<Long> list_front = new ArrayList1<>();
        ...
        while (!list_back.isEmpty()) {

            long get = list_back.get(0);
    ...
    static void A(int t) {
        ...
        if (N == 0L || K == 0L) {
            ...
            ans.append(1).append("\n").append(N).append(" ").append(K);

        } else {

            ans.append(2).append("\n").append(N - 1).append(" ").append(1).append("\n");

            ans.append(N).append(" ").append(K);
