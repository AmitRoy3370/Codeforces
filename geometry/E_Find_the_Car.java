...
public class E_Find_the_Car {
    ...
    static void solve(int t) {
    	...
    	for(long dist : c) {
    		...
    		int index = Math.max(0, lower_bound(a, dist));
    		...
    		if(a[index] == dist) {
    			...
    			long extraDistance = (dist - a[index]) * (b[index + 1] - b[index]) / (a[index + 1] - a[index]);
    			
    			long times = b[index] + extraDistance;
    			
    			//times += extraDistance * oneByV;
