...
public class C_Save_the_Magazines {
    ...
    static long solve(int i, long sum, long max, ArrayList1<Integer> one) {
        ...
        if (!one.isEmpty() && one.get(0) == i) {

            sum += Math.max(a[i], max);
