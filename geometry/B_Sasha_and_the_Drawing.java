...
public class B_Sasha_and_the_Drawing {
    ...
    static long sideLength, coloredDiagonals;
    ...
    static void solve(int t) {
    	...
    	long totalDiagonal = (4L * sideLength - 2L);
    	
    	if(totalDiagonal == coloredDiagonals) {
    		
    		ans.append((2L * sideLength));
    		
    	} else {
    		
    		if(coloredDiagonals % 2L == 0L) {
    			
    			ans.append((coloredDiagonals / 2L));
    ...
    private static void input() throws IOException {
    	...
    	sideLength = in.nextLong();
    	coloredDiagonals = in.nextLong();
