...
public class B_Fun_with_Even_Subarrays {
    ...
    static void solve(){
        ...
        //if the the size of the array is one
        ...
        //if all the element's are unique
        ...
        int ans=0,j=n-1,len=1;

        long last_element=a[n-1];

        --j;

        while(j>=0){

           while(j>=0 && a[j]==last_element){
