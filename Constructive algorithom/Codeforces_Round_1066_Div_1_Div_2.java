...
public class Codeforces_Round_1066_Div_1_Div_2 {
    ...
    static void C(int t) {
        ...
        boolean type1[] = new boolean[n];
        boolean type2[] = new boolean[n];
    ...
    static void A(int t) {
        ...
        for (long i : map.keySet()) {
            ...
            if (i == 0L) {
                ...
                haveToDelete += map.get(i);

            } else if (i != map.get(i) * 1L) {
