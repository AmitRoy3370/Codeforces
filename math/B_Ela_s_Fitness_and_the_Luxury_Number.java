...
public class B_Ela_s_Fitness_and_the_Luxury_Number {
    ...
    static long solve(long n) {
        ...
        long b = new BigInteger(n + "").sqrt().longValue();

        //long square = b * b;
        long finalAns = 0L;

        long b_2 = new BigInteger((b) + "").multiply(new BigInteger(b + "")).longValue();

        finalAns = new BigInteger((b - 1L) + "").multiply(new BigInteger("3")).longValue();

        long left = new BigInteger(n + "").subtract(new BigInteger(b_2 + "")).longValue();

        finalAns = new BigInteger(finalAns + "").add(new BigInteger((left / b) + "")).longValue();
    ...
    static void solve(int t) {
        ...
        long wanted_ans = ((solve(y) - solve(x - 1L)));

        ans.append(wanted_ans);
