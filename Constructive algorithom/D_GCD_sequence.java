...
public class D_GCD_sequence {
    ...
    private static boolean valid(ArrayList1<Long> list) {
    ...
    private static void build(ArrayList1<Long> index, ArrayList1<Long> bIndex) {
    	
    	while(!index.isEmpty()) {
    		
    		long element = index.get(0);
    		...
    		bIndex.add(gcd(element, index.get(0)));
    		
    	}
    	
    }

    private static void build(int index, ArrayList1<Long> list) {
    ...
    static void solve(int t) {
    	...
    	if(index == -1) {
    		...
    		ArrayList1<Long> index_ = new ArrayList1<>();
    		ArrayList1<Long> index_1 = new ArrayList1<>();
    		ArrayList1<Long> index_2 = new ArrayList1<>();
    		
    		build(index, index_);
    		build(index + 1, index_1);
    		build(index + 2, index_2);
    		
    		ArrayList1<Long> bIndex_1 = new ArrayList1<>();
    		ArrayList1<Long> bIndex_2 = new ArrayList1<>();
    		ArrayList1<Long> bIndex_ = new ArrayList1<>();
    		
    		build(index_, bIndex_);
    		build(index_1, bIndex_1);
    		build(index_2, bIndex_2);
    		
    		if(valid(bIndex_) || valid(bIndex_1) || valid(bIndex_2)) {
