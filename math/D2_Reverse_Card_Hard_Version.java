...
public class D2_Reverse_Card_Hard_Version {
    ...
    static long A_, B_, N, M, K, sum = 0L, G, a1, ak, X, Y, A, B, C, l_, t_, P;
    ...
    static void solve(int t) {
    	...
    	for(long i = 1L; i * i <= N; ++i) {
    		...
    		for(long j = 1L; j * j <= M; ++j) {
    			
    			if(gcd(i, j) == 1L) {
    				
    				long value = i + j;
    				
    				sum += Math.min(N / (i * value), M / (j * value));
