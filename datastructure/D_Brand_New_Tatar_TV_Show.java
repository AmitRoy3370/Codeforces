...
public class D_Brand_New_Tatar_TV_Show {
    ...
    static void solve(int t) {
    	...
    	if(map.get(max) % 2 == 0) {
    		...
    		while(!map.isEmpty()) {
    			...
    			long largeElement = map.lastEntry().getKey();
    			
    			int count = map.get(largeElement);
    			
    			Long nextLarge = map.lowerKey(largeElement);
    			
    			if(count % 2 == 0 || (nextLarge != null && largeElement - nextLarge <= k)) {
