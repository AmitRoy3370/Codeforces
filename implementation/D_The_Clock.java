...
public class D_The_Clock {
    ...
    static int testCases, hour, minite, x, n;

    static char a[], b[];

    static String s;

    static long solve(boolean ok, long final_Ans, long b, long c, long d, String p1, String q, long a1, long b1) {
        ...
        if (p1.charAt(0) == p1.charAt(3) && p1.charAt(1) == p1.charAt(2)) {

            final_Ans = Long.parseLong(sum(final_Ans + "", 1 + ""));

        }

        return solve(ok, final_Ans, b, c, d, p1, q, a1, b1);
    ...
    static void solve(int t) {
        ...
        long a1 = x / 60, b1 = x % 60;

        long c = 10 * (a[0] - '0') + (a[1] - '0'), d = 10 * (a[3] - '0') + (a[4] - '0');
        ...
        final_ans = solve(true, final_ans, b1, c, d, p1, q, a1, b1);
