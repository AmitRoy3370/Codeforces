...
public class B_Z_mod_X_C {
    ...
    static void solve(int t) {
        ...
        long x = Long.parseLong(sum(sum(String.valueOf(a), String.valueOf(b)), String.valueOf(c)));

        long y = Long.parseLong(sum(String.valueOf(b), String.valueOf(c)));

        long z = c;

        ans.append(x).append(" ").append(y).append(" ").append(z);
