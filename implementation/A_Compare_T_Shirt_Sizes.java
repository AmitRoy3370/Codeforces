...
public class A_Compare_T_Shirt_Sizes {
    ...
    static void solve(int t) {
        ...
        int countX_for_a = 0, count_extra_for_b = 0, countL_for_a = 0, countL_for_b = 0;
        int countM_for_a = 0, countM_for_b = 0;
        int countS_for_a = 0, countS_for_b = 0;
    ...
    public static void main(String[] Priya) throws IOException {
        ...
        for (int t = 0; t < testCases; ++t) {
            ...
            b = in.next().toLowerCase().toCharArray();
