...
public class C_Permutation_Counting {
    ...
    private static long solve(long permutation, long a[]) {
    ...
    static void solve(int t) {
    	...
    	while(R >= L) {
    		...
    		long value = solve(mid, a);
    		
    		if(value != -1L) {
    			
    			L = mid + 1;
    			
    			sum = Math.max(sum, 1L + value + (mid - 1) * n);
