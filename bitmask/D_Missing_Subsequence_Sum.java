...
public class D_Missing_Subsequence_Sum {
    ...
    static int testCases, n, x_, y_, k, count = 1, d, w, h, a11, b1, f, g, m, s, r, q, a_, b_, c_;
    ...
    static long N, A_, B_, N_, K, sum = 0L, G, a1, ak, X, Y, A, B, C, l_, t_, P;
    ...
    static void solve(int t) {
    	...
    	if(K == 1) {
    		...
    		long msb = (long)(Math.log(left) / Math.log(2));
    		...
    		long difference = left - (1L << msb) + 1;
    		
    		list.add(difference);
    		
    		list.add(K + 1);
    		
    		msb = (long)(Math.log(K + 1) / Math.log(2));
