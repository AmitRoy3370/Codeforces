...
public class B_Subsequence_Update {
    ...
    static int testCases, n, x_, y_, k, count = 1, w, h, a11, b1, f, g, m, s, r, q, a_, b_, c_, N = (int) (1e6 + 1);

    static char x[], y[], z[];

    static long a[], b[], c[], d[], v[], L[], R[], suffix[], prefix[];
    ...
    static void solve(int t) {
    	...
    	ArrayList1<Long> inRange = new ArrayList1<>();
    	ArrayList1<Long> outsideRangeLeft = new ArrayList1<>();
    	ArrayList1<Long> outsideRangeRight = new ArrayList1<>();
    	...
    	for(int i = 0; i < n; ++i) {
    		...
    		if(i >= m && i <= k) {
    			...
    			outsideRangeLeft.add(a[i]);
    			
    		} else if(i > k) {
    			
    			outsideRangeRight.add(a[i]);
    			
    		}
    		
    	}
    	
    	b = new long[inRange.size()];
    	c = new long[outsideRangeLeft.size()];
    	d = new long[outsideRangeRight.size()];
    	
    	int index = 0;
    	
    	while(!inRange.isEmpty()) {
    		
    		b[index++] = inRange.get(0);
    	...
    	while(!outsideRangeLeft.isEmpty()) {
    		
    		c[index++] = outsideRangeLeft.get(0);
    		
    		outsideRangeLeft.popFront();
    		
    	}
    	
    	index = 0;
    	
    	while(!outsideRangeRight.isEmpty()) {
    		
    		d[index++] = outsideRangeRight.get(0);
    		
    		outsideRangeRight.popFront();
    	...
    	sum = fullSum - Long.max(sumLeft, sumRight);
