// Problem: D. Determine Winning Islands in Race
// Contest: Codeforces - Codeforces Round 965 (Div. 2)
// URL: https://codeforces.com/contest/1998/problem/D
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// 
// 
...
public class D_Determine_Winning_Islands_in_Race {
    ...
    static void solve(int t) {
    	...
    	for(int i = 0; i < n - 2; ++i) {
    		...
    		for(int j : list[i]) {
    			...
    			K = Math.max(K, Math.min(j, j - dp[j] - 1));
