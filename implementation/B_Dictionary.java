...
public class B_Dictionary {
    ...
    static void solve(int t) {
        ...
        if (second <= first) {
            ...
            //ans1 = Long.parseLong(sum((mul("26", sub(String.valueOf(first), "1"))), String.valueOf((second - first + 1))));
            ans1 = 26 * (first - 1) + second - first + 1;

        } else {

            ans1 = Long.parseLong(sum((mul("26", sub(String.valueOf(first), "1"))), String.valueOf(second - first)));

            //ans1 = 26 * (first - 1) + second - first;
        }
