...
public class C_MEX_rose {
    ...
    static void solve(int t) {
    	...
    	int elementCount[] = new int[k];
    	
    	int operation = 0, others = 0;
    	int kCount = 0;
    	int repeated = 0;
    	...
    	//System.out.println(kCount + " " + repeated + " " + others);
    	...
    	for(int i = 0, count = 0; i < k; ++i) {
    		...
    		if(!visited[i]) {
    			...
    			} else if(count - kCount <= others) {
    				
    				++operation;
    				
    			} else if(count - kCount - others <= repeated) {
