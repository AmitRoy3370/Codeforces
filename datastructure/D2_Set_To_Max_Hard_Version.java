...
public class D2_Set_To_Max_Hard_Version {
    ...
    static void solve(Deque<Long> queue, int index) {
    	
    	while(!queue.isEmpty() && queue.getLast() <= a[index]) {
    		
    		queue.removeLast();
    		
    	}
    	
    	while(!queue.isEmpty() && queue.getFirst() > b[index]) {
