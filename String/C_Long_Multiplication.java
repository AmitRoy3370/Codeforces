    ...
    static void solve(int t) {
    	...
    	if(allEqual) {
    		...
    		for(int i = firstBit + 1; i != n; ++i) {
    			...
    			if(y[firstBit] > x[firstBit]) {
    				
    				first.append(Math.max(x[i] - '0', y[i] - '0'));
    				second.append(Math.min(x[i] - '0', y[i] - '0'));
    				
    			} else {
    				
    				second.append(Math.max(x[i] - '0', y[i] - '0'));
    				first.append(Math.min(x[i] - '0', y[i] - '0'));
