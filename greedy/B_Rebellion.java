...
public class B_Rebellion {
    ...
    static int solve(int index, long a[], int distance, long value) {
        ...
        return solve(index + distance, a, distance, value);

    }

    static void solve(int t) {

        // find for the best cases
