...
public class C_Sasha_and_the_Casino {
    ...
    static int testCases, n, x, y_, k, count = 1, d, w, h, a11, b1, f, g, m, s, r, q, a_, b_, c_, N = (int) (1e6 + 1);

    static char y[], z[];

    static long b[], c[], v[], L[], R[], suffix[], prefix[];
    ...
    static long a, A_, B_, N_, K, sum = 0L, G, a1, ak, X, Y, A, B, C, l_, t_, P;
    ...
    static void solve(int t) {
    	...
    	long lossesAmount = 0L;
    	
    	for(int i = 0; i != x; ++i) {
    		
    		long loss = (lossesAmount + k - 1) / (k - 1);
    	...
    	long totalEarn = k * (a - lossesAmount);
    ...
    static void copy(int j, int i, long b[], long a[]) {
