...
public class C_Clock_Conversion {
    ...
    static String actualHour(int hh) {
    ...
    static void solve(int t) {
    	...
    	int hh = Integer.parseInt(x[0] + "" + x[1]);
    	int mm = Integer.parseInt(x[3] + "" + x[4]);; 
    	
    	String min = 10 > mm ? "0" + mm : "" + mm;
    	...
    	if(12 > hh) {
    		...
    		ans.append(actualHour(hh)).append(":").append(min).append(" AM");;
    		
    	} else if(hh == 12) {
    		
    		ans.append(hh).append(":").append(min).append(" PM");
    		
    	} else {
    		
    		hh %= 12;
    		
    		ans.append(actualHour(hh)).append(":").append(min).append(" PM");
