...
public class D_Fixing_a_Binary_String {
    ...
    private static byte[] build(byte aa[], int n, int p) {
    ...
    private static boolean check(byte bb[], int n, int k) {
