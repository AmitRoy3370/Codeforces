...
public class C_Chat_Ban {
    ...
    static void solve(){
        ...
        while(right>=left ){
            ...
            mid=(long)Math.ceil(((left+right))/2);
          //  out.print("left: "+left+" right: "+right);
           // out.flush();
            
            sum=(mid<=k)?(mid*(mid+1))/2:(1 + k) * k / 2 + (3 * k - 1 - mid) * (mid - k) / 2;
     ...
     out.println(ans==2*k-1?ans:(ans+1) );
     out.flush();
