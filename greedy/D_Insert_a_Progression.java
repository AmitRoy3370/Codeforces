...
public class D_Insert_a_Progression {
    ...
    static void solve(int t) {
        ...
        if (n == 1) {
            ...
            long min = (a[0] > 1 ? Math.abs(a[0] - 1) : 0) + (a[0] < k ? Math.abs(a[0] - k) : 0);

            ans.append(min);

        } else {

            long diffOne = Math.min(Math.abs(a[0] - 1), Math.abs(a[n - 1] - 1));
            long diffK = Math.min(Math.abs(a[0] - k), Math.abs(a[n - 1] - k));
            ...
            for (int i = 0; i < n; ++i) {
                ...
                diffOne = Math.min(diffOne, Math.abs(a[i] - 1) * 2);
                diffK = Math.min(diffK, Math.abs(a[i] - k) * 2);
