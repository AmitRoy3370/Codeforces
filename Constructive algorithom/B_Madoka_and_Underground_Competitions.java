...
public class B_Madoka_and_Underground_Competitions {
    ...
    static int testCases, n, k, r, c;

    static char x[], y[];

    static void solve(int t) {

        char finalAns[][] = new char[n + 1][n + 1];
