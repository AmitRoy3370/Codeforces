...
public class C_Virus {
    ...
    static long solve(int i, long difference[], long finalAns) {
        ...
        if (difference[i] - day * 2L > 0) {
            
            long result = difference[i] - 2L * day;
            ...
            if (result == 1L || result == 2L) {
                ...
                finalAns += difference[i] - day * 2L - 1L;
                
            }
            
        }
        
        return solve(i + 1, difference, finalAns);
        
    }
    
    static void solve(int t) {
        
        long difference[] = new long[m];
        
        sort(a, 0, m - 1);
        
        for (int i = 1; i < m; ++i) {
            
            difference[i] = a[i] - a[i - 1] - 1L;
            
        }
        
        difference[0] = a[0] - 1L + (n - a[m - 1]);
        
        sort(difference, 0, m - 1);
        
        reverse(difference);
        
        long finalAns = 0L;
        
        finalAns = solve(0, difference, finalAns);
        
        n = Long.parseLong( sub(n + "", finalAns + "") );
    ...
    public static void main(String[] Priya) throws IOException {
        ...
        for (int t = 0; t < testCases; ++t) {
            ...
            m = Math.min(in.nextInt(), (int) Math.pow(10, 5));
