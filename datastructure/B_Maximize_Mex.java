...
public class B_Maximize_Mex {
    ...
    static void solve(int t) {
    	...
    	//System.out.println(t + " :- " + initialMex);
    	
    	long maxMex = initialMex;
    	
    	//System.out.println("maxMex :- " + maxMex);
    	...
    	for(long i = 0; i <= n; ++i) {
    		...
    		if(map.getOrDefault(i, 0) == 0) {
    			...
    			maxMex = Math.max(i, maxMex);
    			break;
    			
    		}
    		
    		map.put(i + K, map.getOrDefault(i + K, 0) + map.get(i) - 1) ;
