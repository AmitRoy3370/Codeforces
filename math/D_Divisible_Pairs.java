...
public class D_Divisible_Pairs {
    ...
    static long x, y, A_, B_, N_, K, sum = 0L, G, a1, ak, X, Y, A, B, C, l_, t_, P;
    ...
    static void solve(int t) {
    	...
    	for(long i : a) {
    		...
    		long previousFirst = (first == 0L ? 0L : x - first);
    		long previousSecond = second; 
    		
    		String s_ = previousFirst + "_" + previousSecond;
    		
    		pair += map.getOrDefault(s_, 0);
