...
public class B_Game_on_Ranges {
    ...
    static int testCases,n,l[],r[];
    
    static void solve()
    {
        
        Vector<pairElement> a=new Vector<>();
     ...
     //   Map<Integer,Integer> countB=new HashMap<>();
        ...
        for(int i=0;i<n;i++){
            ...
            a.add(new pairElement(l[i],r[i]) );
            
            countA.put(l[i], countA.getOrDefault(l[i], 0)+1 );
            
            countA.put(r[i], countA.getOrDefault(r[i], 0)+1 );
        ...
        for(pairElement i: a){
            ...
            out.println(i.left+" "+i.right+" "+i.ans);
            out.flush();
    ...
    static class pairElement implements Comparable<pairElement> {
        
        int left,right,ans;

        public pairElement(int left, int right) {
            this.left = left;
            this.right = right;
        }

        @Override
        public int compareTo(pairElement t) {
        //    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        
        /*if(this.left-this.right==t.left-t.right ){
            
            return Integer.compare(this.left, t.left);
            
        }*/
        
          return Integer.compare(-this.left+this.right+1, -t.left+t.right+1);
