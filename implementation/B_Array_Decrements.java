...
public class B_Array_Decrements {
    ...
    static long solve(int i, long max) {
        ...
        max = Math.max(max, Long.parseLong(sub(a[i] + "", b[i] + "")));
    ...
    static void solve(int t) {
        ...
        if (prev == present) {
            ...
            while (!list.isEmpty()) {
                ...
                long distance = list.get(0);

                if (max_distance > distance && b[index] > 0) {
