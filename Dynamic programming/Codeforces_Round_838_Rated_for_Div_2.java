...
public class Codeforces_Round_838_Rated_for_Div_2 {
    ...
    static void solveC(int i, long dp[][]) {
    ...
    static void B(int t) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            long element = (long) (Math.log(a[i]) / Math.log(2));

            long op = ((1 << (element + 1)) - a[i]);

            sb.append((i + 1)).append(" ").append(op).append("\n");
    ...
    static void A(int t) {
        ...
        if (sum % 2L == 0L) {
            ...
            for (int i = 0; i < n; ++i) {
                ...
                int step = 0, mod = (int) (a[i] % 2L);

                //System.out.println("element : " + a[i]);
                while ((int) (a[i] % 2L) == mod) {
