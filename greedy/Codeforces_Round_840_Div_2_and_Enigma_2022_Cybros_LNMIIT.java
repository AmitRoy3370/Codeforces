...
public class Codeforces_Round_840_Div_2_and_Enigma_2022_Cybros_LNMIIT {
    ...
    static long height, mod = 998244353L;

    static void solveB(int i, long sum, int t, long min[]) {
    ...
    static void B(int t) {
        ...
        solveB(i, damage, t, min);

        int present = ans.length();
    ...
    static long sum(int i, long a[], long sum) {
