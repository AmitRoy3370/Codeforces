...
public class A_Glory_Addicts {
    ...
    static void solve(int t) {
        ...
        long Fire[] = new long[fire];
        long Frost[] = new long[frost];
        ...
        sort(Fire, 0, Fire.length - 1);
        sort(Frost, 0, Frost.length - 1);
        ...
        while (i < Fire.length && j < Frost.length) {
