// Problem: D. Sasha and a Walk in the City
...
public class D_Sasha_and_a_Walk_in_the_City {
    ...
    static void D(int node, List<Integer> list[], long dp[], boolean visited[]) {
