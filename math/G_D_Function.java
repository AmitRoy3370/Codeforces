...
// URL: https://codeforces.com/contest/1985/problem/G
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// 
// 
...
public class G_D_Function {
    ...
    static void solve(int t) {
    	...
    	if(K >= 10L) {
    		...
    		long possibleDigit = (10L / K) + (10 % K == 0 ? 0 : 1);
    		
    		long rightPossible = pow(possibleDigit, R);
    		long leftPossible = pow(possibleDigit, L);
    		
    		long totalPossible = (rightPossible - leftPossible + mod) % mod;
    		
    		ans.append(totalPossible);
