...
public class E_Iva_Pav {
    ...
    static long K[], a[], b[], c[], v[], suffix[], prefix[];
    ...
    static long A_, B_, N_, sum = 0L, G, a1, ak, X, Y, A, B, C, l_, t_, P;
    ...
    private static class Tree {
    	...
    	long query(int a, int b) {
    		...
    		return operation(table[size][a], table[size][b - (1 << size) + 1]);
