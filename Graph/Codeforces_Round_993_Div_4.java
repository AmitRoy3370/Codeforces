...
public class Codeforces_Round_993_Div_4 {
    ...
    static void G1(int t) {
        ...
        ArrayList1<Long> sender = new ArrayList1<>();
        ...
        while(!sender.isEmpty()) {
            ...
            ArrayList1<Long> newSenders = new ArrayList1<>();
            
            ++sum;
            
            while(!sender.isEmpty()) {
                
                long presentSender = sender.get(0);
                
                map.put(a[(int)presentSender], map.get(a[(int)presentSender]) - 1);
                
                if(map.getOrDefault(a[(int)presentSender], 0) == 0) {
                    
                    newSenders.add(a[(int)presentSender]);
            ...
            while(!newSenders.isEmpty()) {
                
                sender.add(newSenders.get(0));
    ...
    static void A(int t) {
        ...
        for (int i = 1; i <= n; ++i) { // check for a

            for (int j = 1; j <= n; ++j) { // check for b

                if (i + j == n) { // find a pair of a and b

                    ++sum; // just increase our count.
