...
public class C_Remove_Exactly_Two {
    ...
    static int testCases, n, x_, y_, k, count = 1, d, w, h, a11, b1, f, g, m, s, r, q, a_, b_, c_, N = (int) (1e6 + 1), u[], v[];
    ...
    static void solve(int t) {
    	...
    	for(int i : degree) {
    		...
    		maxDegree = Math.max(i, maxDegree);
    	...
    	for(int i = 0; i < n; ++i) {
    		...
    		if(degree[i] == maxDegree) {
    			...
    			int copyDegree[] = degree.clone();
    			
    			for(int neighbour : list[i]) {
    				
    				copyDegree[neighbour]--;
    				
    			}
    			
    			copyDegree[i] = 0;
    			
    			for(int j : copyDegree) {
