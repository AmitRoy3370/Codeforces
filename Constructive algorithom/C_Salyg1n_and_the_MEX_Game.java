...
public class C_Salyg1n_and_the_MEX_Game {
    ...
    static int testCases, n, k, count = 0, d, w, h, a11, b1, f, g, m, s, r, q, a_, b_, c_;

    static char x[], y[], z[];

    static long a[], b[], c[], v[], dp[], L[], R[], suffix[], prefix[];
    ...
    static long N, K, sum = 0L, G, a1, ak, X, Y;

    static long A[][];

    static char mat[][];

    static long H, mod = (long) (Math.pow(10, 9) + 7L);
