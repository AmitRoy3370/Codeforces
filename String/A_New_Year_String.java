...
public class A_New_Year_String {
    ...
    static void solve(int t) {
    	...
    	if(!new String(x).contains("2025")) {
    		
    		ans.append("0");
    		
    	} else if(new String(x).contains("2026")) {
    		
    		ans.append("0");
    		
    	} else if(new String(x).contains("202")) {
    		
    		ans.append("1");
    		
    	} else if(new String(x).contains("20")) {
    		
    		ans.append("2");
    		
    	} else if(new String(x).contains("2")) {
