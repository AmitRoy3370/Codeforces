...
public class E_2_Letter_Strings {
    ...
    private static Map<Character, Integer> first = new HashMap<>();
    private static Map<Character, Integer> second = new HashMap<>();

    private static long solve(int index, String a[], long finalAns) {
        ...
        finalAns += Long.parseLong(sub(sum(String.valueOf(first.get(a[index].charAt(0))), String.valueOf(second.get(a[index].charAt(1)))), String.valueOf(2 * map.get(a[index]))));

        map.put(a[index], map.get(a[index]) + 1);
        first.put(a[index].charAt(0), first.get(a[index].charAt(0)) + 1);
        second.put(a[index].charAt(1), second.get(a[index].charAt(1)) + 1);

        return solve(index - 1, a, finalAns);
    ...
    private static void solve(int t) {
        ...
        ans.append(solve(n - 1, a, finalAns));
